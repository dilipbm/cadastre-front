<template>
  <div class="row">
    ...
    <b-modal id="modalIdTask" ok-only>
      <template #modal-title>Votre ID</template>
      <div class="container">
        <p>
          Conserver votre ID. Il sera demandé pour télécharger votre fichier de
          résultat
        </p>
        <div class="task-with-btn">
          <div class="task-id mr-3">
            <p>{{ taskId }}</p>
          </div>
          <!-- <div class="btn-copy">
              <b-button variant="outline-info" @click="copy">
